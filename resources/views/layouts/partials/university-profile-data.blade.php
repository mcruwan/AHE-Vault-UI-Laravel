                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <a href="https://sunwayuniversity.edu.my/"
                                class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">Sunway University</a>
                            <a href="https://sunwayuniversity.edu.my/">
                ...
                <div class="d-flex flex-wrap flex-stack">
                    ...
                    <div class="d-flex align-items-center w-200px w-sm-300px flex-column mt-3">
                        ...
                        <div class="h-5px mx-3 w-100 bg-light mb-3">
                            <div class="bg-success rounded h-5px" role="progressbar" style="width: 40%;"
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
            ...
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 active"
                    href="{{ url('university-overview') }}">Overview</a>
            </li>
        </ul>
    </div>
</div>
