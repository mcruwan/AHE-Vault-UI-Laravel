        ...
        <div class="ms-3">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                ...
                <div class="menu-item px-5 my-1">
                    <a href="{{ url('#') }}" class="menu-link px-5">Account Settings</a>
                </div>
                <!--end::Menu item-->
                <!--begin::Menu item-->
                <div class="menu-item px-5">
            ...
            <div class="d-flex align-items-center flex-column w-100 mb-6">
                ...
                <div class="d-block justify-content-between fs-6 text-gray-800 w-100 mb-3">
                    <a href="https://sunwayuniversity.edu.my/" target="_blank">
                        <img alt="Logo" src="assets/media/logos/sunway-logo.jpg"
                            class="h-70px h-lg-70px theme-light-show" />
                        <img alt="Logo" src="assets/media/logos/sunway-logo-dark.png"
                            class="h-70px h-lg-70px theme-dark-show" />
                    </a>
                    <a href="https://sunwayuniversity.edu.my/" target="_blank" class="d-block fw-bolder mt-3">Sunway
                        University</a>
                ...
                <div class="border border-gray-300 border-dashed rounded min-w-100px w-100 p-4 mb-3">
                    ...
                    <div class="w-100 bg-light-primary rounded" style="height: 24px">
                        <div id="uni-progress" class="rounded" role="progressbar"
                            style="height: 24px; width: 37%;background: #17c653;" aria-valuenow="50"
                    ...
                    <div class="d-flex w-100 mt-2">
                        ...
                        <div class="fw-semibold fs-7 text-primary w-50 text-right">
                            <a href="{{ url('university-edit') }}">Complete profile</a>
                        </div>
                    </div>
                </div>
