                ...
                <div id="kt_app_content_container" class="app-container container-xxl py-15">
                    ...
                    <div class="text-center">
                        <img alt="Logo" src="assets/media/logos/ahe-vault-logo.png"
                            class="h-40px h-lg-70px theme-light-show" />
                    </div>
                    ...
                    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid gap-10"
                        ...
                        <div
                            ...
                            <div class="card-body px-6 px-lg-10 px-xxl-15 py-20">
                                ...
                                <div class="stepper-nav">
                                    <!--begin::Step 1-->
                                    <div id="stepper-item-1" class="stepper-item">
                                        <!--begin::Wrapper-->
                                    ...
                                    <!--end::Step 1-->
                                    <!--begin::Step 2-->
                                    <div id="stepper-item-2" class="stepper-item">
                                        <!--begin::Wrapper-->
                                        <div class="stepper-wrapper">
                                            <!--begin::Icon-->
                                            <div class="stepper-icon w-40px h-40px">
                                    ...
                                    <!--end::Step 2-->
                                    <!--begin::Step 3-->
                                    <div id="stepper-item-3" class="stepper-item">
                                        <!--begin::Wrapper-->
                                        <div class="stepper-wrapper">
                                            <!--begin::Icon-->
                                            <div class="stepper-icon w-40px h-40px">
                        ...
                        <div class="card d-flex flex-row-fluid flex-center">
                            ...
                            <div class="card-body py-20 w-100 mw-xl-700px px-9">
                                <!--begin::Step 1-->
                                <div id="step-1" class="steps" data-kt-stepper-element="content">
                                    <!--begin::Wrapper-->
                                    <form id="user-profile-form" action="javascript:showStep('2');">
                                        <div class="w-100">
                                            <!--begin::Heading-->
                                            ...
                                            <div class="fv-row mb-8">
                                                <!--begin::Label-->
                                                <label class="fw-semibold required">First Name</label>
                                            ...
                                            <div class="fv-row mb-8">
                                                ...
                                                <input id="confirm-password" name="confirm-password" type="password"
                                                    autocomplete="off" required class="form-control bg-transparent" />
                                                <span id="message" class="invalid-feedback d-block mt-3"></span>
                                                <!--end::Repeat Password-->
                                            </div>
                                            <!--end::Input group=-->
                                            <!--begin::Accept-->
                                ...
                                <!--end::Step 1-->
                                <!--begin::Step 2-->
                                <div id="step-2" class="steps" data-kt-stepper-element="content">
                                    <!--begin::Wrapper-->
                                    <form id="uni-profile-form" action="javascript:showStep('3');">
                                        <div class="w-100">
                                            <!--begin::Heading-->
                                            ...
                                            <div class="fv-row mb-10">
                                                ...
                                                <select name="country" required aria-label="Select a Location"
                                                    ...
                                                    <option data-kt-flag="flags/isle-of-man.svg" value="IM">Isle of
                                                        Man
                                                    </option>
                                            ...
                                            <div class="fv-row mb-10">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <input type="url" name="fname" required
                                ...
                                <!--end::Step 2-->
                                <!--begin::Step 3-->
                                <div id="step-3" class="steps" data-kt-stepper-element="content">
                                    <!--begin::Wrapper-->
                                    <div class="w-100">
                                        <!--begin::Heading-->
                                        ...
                                        <div class="text-center px-4 pb-15">
                                            <img src="assets/media/illustrations/sigma-1/2.png" alt=""
                                        ...
                                        <div class="mb-0">
                                            <!--begin::Text-->
                                            <div class="fs-4 text-center text-gray-600 mb-5">Thank you for your data
                                                submission. We will notify you once it's validated.</div>
